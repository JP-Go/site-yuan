...
export function HumanizedCollection() {
  return (
    <div className="flex flex-col-reverse gap-8 items-center p-8 w-full md:flex-row lg:p-20 bg-humanized-collection text-humanized-button-text">
      <div className="flex flex-col gap-6 px-10">
        ...
        <a className="px-4 py-2 text-xl font-bold text-center rounded-lg cursor-pointer lg:py-4 lg:text-4xl bg-yuan-yellow text-primary" href="#proposta">Confira mais informações!</a>
      </div>
